                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" @submit.prevent="submit">
                    <div class="form-group">
                      ...
                      <input type="text"  v-model="name" class="form-control  p-4" id="exampleInputUsername1" placeholder="Username">
...
send()
{
  this.$inertia.post('/admin/category/create',{'name' : this.name});
}
}
